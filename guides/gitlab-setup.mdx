...
Install the [Autter CLI](/cli/install) to attach agent, model, and prompt context to committed lines. Connected mode lets the Autter platform join that attribution to GitLab merge requests and team analytics.
