...
Install the [Autter CLI](/cli/install) to attach agent, model, and prompt context to committed lines. Connected mode lets the Autter platform join that attribution to GitHub pull requests and team analytics.
