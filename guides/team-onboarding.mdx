...
Node-centric teams can distribute the CLI through npm instead — `npm install -g autter` installs the same release binary and fits existing Node toolchains and setup scripts.
