...
For fish, use `source "$HOME/.autter/env.fish"`. New terminals load it automatically through your shell configuration; IDE terminals need an IDE restart, not just a new terminal tab.
