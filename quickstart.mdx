...
Install the open source CLI when you want to track which agent, model, and prompt produced each line. This attribution can remain local or connect to the Autter platform for team-level analytics.
...
See [Autter CLI](/cli/overview) for installation, connected mode, and data controls.
