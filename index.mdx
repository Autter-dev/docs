...
<CardGroup cols={2}>
  ...
  <Card title="Autter Runtime" icon="satellite-dish" href="/runtime/introduction">
    Add lightweight, open source error and usage tracking to your app's frontend and backend.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="MCP server" icon="bot" href="/features/mcp">
    Connect a coding agent to read reviews, fix findings, and query the codebase.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Runtime quickstart" icon="rocket" href="/runtime/quickstart">
    Go from zero to seeing error and usage data flowing.
  </Card>
  <Card title="Runtime introduction" icon="satellite-dish" href="/runtime/introduction">
    Understand the packages, supported stacks, and data model.
  </Card>
</CardGroup>
