...
<Info>
  Prefer to have an AI coding agent set this up for you? Install the companion skills, then tell your agent *"install Autter Runtime in this project"*: `npx skills add Autter-dev/autter-skills --all`. See [Autter-dev/autter-skills](https://github.com/Autter-dev/autter-skills).
</Info>
