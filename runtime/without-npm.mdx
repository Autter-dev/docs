...
Then tell your coding agent: *"install Autter Runtime in this project"* — it inventories the services, picks the right per-language approach from above, and wires it up. See [AI agent skills](/runtime/skills) for the full setup walkthrough.
